...
## 7. Decisões do dono (pendentes: **(c)** e **(f)** — (b) e (d) DECIDIDAS e (e) MEDIDA em 20/09/2026)
...
da tabela. Em 20/09 o dono decidiu a **(b)** e a **(d)**, e a **(e)** deixou de ser decisão: foi MEDIDA em produção e bate com o esquema local. **(c)** e **(f)** continuam pendentes.
