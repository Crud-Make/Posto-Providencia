> **ARQUIVADO em 17/09/2026.** Este era o `CLAUDE.md` versão 3.3, substituído pelo novo conjunto de regras da refatoração Laravel. Fica aqui como referência de processo e de incidentes; a regra que vale é a do `CLAUDE.md` da raiz.
