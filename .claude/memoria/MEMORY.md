...
- [📍 Validação final — onde parei](validacao-final-onde-parei.md) — 16/08: branch `test/validacao-final`, app do dono provado à mão pelo dono; 5 pendências, nenhuma de código; janeiro NÃO se reconstrói pelo app
