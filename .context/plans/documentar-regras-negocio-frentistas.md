...
# Documentação: Regras de Negócio do Posto (Taxas e Margens) Plan

> Documentar as regras de negócio extraídas da planilha Excel (taxas de cartão, margens de lucro, cálculos de fechamento) na pasta .context/docs antes de implementar melhorias na tela de frentistas.
...
- **Total symbols discovered:** 580
- **Architecture layers:** Config, Utils, Repositories, Controllers, Services, Components, Models
- **Entry points:** packages/utils/src/index.ts, packages/types/src/index.ts, packages/api-core/src/index.ts (+30 more)

### Key Components

**Key Interfaces:**
- `SubmitClosingData` — /home/thygas/.gemini/antigravity/scratch/Posto-Providencia/packages/types/src/api.ts:9
- `NotaFrentistaInput` — /home/thygas/.gemini/antigravity/scratch/Posto-Providencia/packages/types/src/api.ts:29
- `ApiResponse` — /home/thygas/.gemini/antigravity/scratch/Posto-Providencia/packages/types/src/api.ts:37
- `ApiError` — /home/thygas/.gemini/antigravity/scratch/Posto-Providencia/packages/types/src/api.ts:48
- `VendaProduto` — /home/thygas/.gemini/antigravity/scratch/Posto-Providencia/apps/mobile/services/vendaProduto.ts:6
## Agent Lineup
